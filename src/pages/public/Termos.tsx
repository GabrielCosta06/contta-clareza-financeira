  ...
  return (
    <div className="container py-16 max-w-3xl">
      ...
      <section className="mt-8 space-y-6 text-foreground">
        <div><h2 className="text-lg font-semibold">1. Objeto</h2><p className="mt-2 text-muted-foreground">O Contta é uma plataforma web de leitura financeira para PMEs brasileiras. Não substitui sua contabilidade nem aconselhamento fiscal especializado.</p></div>
